export const metadata = {
  title: "Privacy Policy | Email Attachment Size Checker",
  description: "Privacy policy for Email Attachment Size Checker. Learn how we handle data, cookies, and third-party services including Google AdSense and Google Analytics.",
  ...
  return (
    <main style={{ maxWidth: "780px", margin: "0 auto", padding: "2rem 1.5rem", fontFamily: "'DM Mono', monospace", color: "#1a1a1a", background: "#faf8f4", minHeight: "100vh" }}>
      <p style={{ fontSize: "12px", marginBottom: "1.5rem" }}>
        <a href="/" style={{ color: "#1a5ca8", textDecoration: "none" }}>← Back to Email Attachment Size Checker</a>
      </p>
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ fontSize: "13px", lineHeight: "1.8", color: "#444" }}>
          Email Attachment Size Checker (emailattachmentsize.com) is a free tool that helps you determine whether a file can be sent as an email attachment across major providers. It is operated by MoneyWise Calculators, a network of free online tools. This privacy policy explains what information is collected when you use this site, how it is used, and your rights regarding that information.
        </p>
      </section>
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ fontSize: "13px", lineHeight: "1.8", color: "#444" }}>
          We do not collect, store, or transmit any file data you interact with on this tool. When you drop a file or enter a file size, all processing happens entirely within your browser. No file content, file name, or size data is sent to our servers, stored in a database, or shared with any third party. We do not require you to create an account or provide an email address to use this tool.
        </p>
      </section>
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ fontSize: "13px", lineHeight: "1.8", color: "#444", marginTop: ".75rem" }}>
          ...
          <a href="https://www.google.com/settings/ads" style={{ color: "#1a5ca8" }} target="_blank" rel="noopener noreferrer">Google Ads Settings</a>.
          For more information on how Google uses data from sites that use its advertising services, visit{" "}
          <a href="https://policies.google.com/technologies/partner-sites" style={{ color: "#1a5ca8" }} target="_blank" rel="noopener noreferrer">How Google uses information from sites or apps that use our services</a>.
        </p>
      </section>
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ fontSize: "13px", lineHeight: "1.8", color: "#444", marginTop: ".75rem" }}>
          ...
          <a href="https://tools.google.com/dlpage/gaoptout" style={{ color: "#1a5ca8" }} target="_blank" rel="noopener noreferrer">Google Analytics Opt-out Browser Add-on</a>.
        </p>
      </section>
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ fontSize: "13px", lineHeight: "1.8", color: "#444" }}>
          ...
          <a href="https://myaccount.google.com" style={{ color: "#1a5ca8" }} target="_blank" rel="noopener noreferrer">Google Account settings</a>.
        </p>
      </section>
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ fontSize: "13px", lineHeight: "1.8", color: "#444" }}>
          ...
          <a href="https://moneywisecalculator.com" style={{ color: "#1a5ca8" }}>MoneyWise Calculator</a>.
        </p>
      </section>
